...
data class DotaMap(
    ...
    val ward_purchase_cooldown: Float? = null,
    val radiant_ward_purchase_cooldown: Float? = null,
    val dire_ward_purchase_cooldown: Float? = null,
    val roshan_state: String? = null,
    val roshan_state_end_seconds: Float? = null
)
...
data class Item(
    val name: String,
    val purchaser: Float? = null,
    val can_cast: Boolean? = null,
