...
/**
 * Triggers when the current hero dies.
 */
object OnDeath : SoundTrigger {

    override val name get() = stringResource("trigger_name_death")
    override val description get() = stringResource("trigger_desc_death")
