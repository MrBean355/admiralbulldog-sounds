...
/**
 * Triggers when the player's team wins the match.
 */
object OnVictory : SoundTrigger {

    override val name get() = stringResource("trigger_name_victory")
    override val description get() = stringResource("trigger_desc_victory")
